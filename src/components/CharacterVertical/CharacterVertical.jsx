...
import "./CharacterVertical.css"
const CharacterVertical =(props)=> {
  return (
    <div className='ContenedorVertcial'>
      <img className='ContenedorVertical-Imagen' src={props.img} alt="Imagen" />
                <div className='ContenedorVertical-Informacion'>
...
export default CharacterVertical
